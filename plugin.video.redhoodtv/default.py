...
#############Defined Strings#############
addon_id     = 'plugin.video.redhoodtv'
...
Guide = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.redhoodtv/resources/catchup', 'guide.xml'))
GuideLoc = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.redhoodtv/resources/catchup', 'g'))
...
def start():
	if username=="":
		...
		if auth == "":
			...
			line2 = "Welcome to Redhood TV" 
			line3 = ('[COLOR red]%s[/COLOR]'%user)
			xbmcgui.Dialog().ok('Redhood TV', line1, line2, line3)
			tvguidesetup()
			addonsettings('ADS2','')
			xbmc.executebuiltin('Container.Refresh')
			home()
...
def addonsettings(url,description):
	if   url =="CC":
		...
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.redhoodtv/resources/modules/speedtest.py")')
	elif url =="META":
...
def correctPVR():
	...
	addon = xbmcaddon.Addon('plugin.video.redhoodtv')
